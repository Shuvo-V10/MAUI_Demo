...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001a58, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001a57, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x4f39d146638cd0cb, ; from name: Test.dll.so
		i64 u0x6bfc60b3486467d9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Test.dll.so
		ptr null; void* handle
	}, ; 209
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x50d51aeb6080d186, ; from name: aot-Test.so
		i64 u0x6bfc60b3486467d9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Test.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x6bfc60b3486467d9, ; from name: libaot-Test.dll.so
		i64 u0x6bfc60b3486467d9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Test.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7769c6c0f4886554, ; from name: aot-Test.dll.so
		i64 u0x6bfc60b3486467d9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Test.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7d9344d394c22b17, ; from name: Test.so
		i64 u0x6bfc60b3486467d9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Test.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb3f5bb77a55fad5e, ; from name: Test
		i64 u0x6bfc60b3486467d9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Test.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc1c25ef3a34e03cb, ; from name: aot-Test
		i64 u0x6bfc60b3486467d9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Test.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd4bea65099193e65, ; from name: libaot-Test
		i64 u0x6bfc60b3486467d9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Test.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdddb56a8a7c374da, ; from name: libaot-Test.so
		i64 u0x6bfc60b3486467d9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Test.dll.so
		ptr null; void* handle
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [19 x i8] c"libaot-Test.dll.so\00", align 16
